function checkUsername() {                        // Declare function
  let username = el.value;                        // Store username in variable
...
const el = document.getElementById('username');     // Username input
const elMsg = document.getElementById('feedback');  // Element to hold message
