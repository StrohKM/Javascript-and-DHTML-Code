...
function addItem() {
	...
	const numberOfItems = elList.getElementsByTagName('li').length + 1;
	let defaultText =  `add new item as ${numberOfItems} item`;
	let item = prompt("Enter new item:", defaultText);
	...
	if(item === null || item.trim() === "" || item === defaultText)
	{
...
function removeItem(e) {  
	//step 2.1: Add a parameter in the function header to reference the event object. 
	e.preventDefault();
